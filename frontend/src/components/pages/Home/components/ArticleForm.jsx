...
const ArticleForm = ({ user }) => {
  ...
  return (
    <div className="h-[100%] w-[100%] gap-2 flex flex-col text-start items-center justify-center">
      <div
        className="w-[90%] p-4 h-[130px]  flex flex-col gap-2 bg-slate-100 drop-shadow-lg rounded-[10px] active:outline-slate-300 focus:outline-slate-300 "
        value={areaValue}
      ...
      >
        ...
        <div className="flex flex-row text-center items-center justify-between">
          <textarea
            className="w-[75%] p-2 h-[50px] resize-none bg-slate-100 active:outline-slate-300 focus:outline-slate-300 rounded-[10px] border-[2px]"
